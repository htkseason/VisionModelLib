...
Example 1 : AAM-Fitting (Usage of Appearance-Model, Texture-Model and Shape-Model)  
...
Example 2 : ASM-Tracking (Usage of Patch-Regressor and Shape-Model)  
[github.com/htkseason/ASM-Tracking](https://github.com/htkseason/ASM-Tracking)  
![ASM-Tracking](https://github.com/htkseason/ASM-Tracking/blob/master/demo.jpg)  
  
Example 3 : Face-Twisting (Usage of Shape-Model and triangle mesh)  
